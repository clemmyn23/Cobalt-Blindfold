"""
CODE FROM https://github.com/Twentysix26/Red-DiscordBot/blob/develop/cogs/utils/chat_formatting.py

LICENSED UNDER GNU v3
FULL LICENCE CAN BE FOUND AT https://www.gnu.org/licenses/gpl-3.0.en.html
 """
